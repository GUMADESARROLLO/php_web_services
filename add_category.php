        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title"><?php if(isset($_GET['cat_id'])){?>Edit<?php }else{?>Agregar<?php }?> Categoria</div>
            </div>
          </div>
              ...
              <div class="section">
                <div class="section-body">
                  <div class="form-group">
                    <label class="col-md-3 control-label">Nombre de Categoria :-
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Seleccione Imagen :-
                      <p class="control-label-help">(Resolucion recomendada: 150*200,180*300 ,200*350 o Rectángulo)</p>
                    </label>
                    <div class="col-md-6">
