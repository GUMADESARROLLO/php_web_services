  ...
  <aside class="app-sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
      <ul class="sidebar-nav">
        ...
        <li <?php if($currentFile=="manage_news.php" or $currentFile=="add_news.php" or $currentFile=="edit_news.php" or $currentFile=="comments_news.php"){?>class="active"<?php }?>> <a href="manage_news.php">
          ...
          <ul class="nav navbar-nav navbar-mobile">
            ...
            <li>
              <button type="button" class="navbar-toggle">
                ...
                <?php }else{?>
                  <img class="profile-img" src="assets/images/profile.png" style="width: 10px">
                <?php }?>
