...
//Active and Deactive featured
  if(isset($_GET['featured_deactive_id']))
  {
    ...
    $edit_status=Update('tbl_news', $data, "WHERE id = '".$_GET['featured_deactive_id']."'");
  ...
  if(isset($_GET['featured_active_id']))
  {
    ...
    $edit_status=Update('tbl_news', $data, "WHERE id = '".$_GET['featured_active_id']."'");
        ...
        <div class="card mrg_bottom">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Gestor de Noticias</div>
            </div>
            <div class="col-md-7 col-xs-12">
              <div class="search_list">
                <div class="search_block">
                      <form  method="post" action="">
                        <input class="form-control input-sm" placeholder="Buscar noticia..." aria-controls="DataTables_Table_0" type="search" name="search_text" required>
                        <button type="submit" name="data_search" class="btn-search"><i class="fa fa-search"></i></button>
                      </form>  
                    </div>
                <div class="add_btn_primary"> <a href="add_news.php">Agregar</a> </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="wall_category_block">
                    <h2><?php echo $row['category_name'];?></h2> 
					 <?php if($row['featured']!="0"){?>
                         <a href="manage_news.php?featured_deactive_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="Slider"><div style="color:green;"><i class="fa fa-check-circle"></i></div></a> 
                      <?php }else{?>
                         <a href="manage_news.php?featured_active_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="Set Slider"><i class="fa fa-circle"></i></a> 
                      <?php }?>             
                  </div>
                  <div class="wall_image_title">
                    ...
                    <ul>
                      ...
                      <li><a href="edit_news.php?news_id=<?php echo $row['id'];?>" data-toggle="tooltip" data-tooltip="Edit"><i class="fa fa-edit"></i></a></li>
                        <li><a href="comments_news.php?news_id=<?php echo $row['id'];?>" data-toggle="tooltip" target="_blank" data-tooltip="Comentarios"><i class="fa fa-comments"></i></a></li>
