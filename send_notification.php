<?php include("includes/header.php");
  ...
  $data_qry="SELECT * FROM tbl_news ORDER BY id DESC";
  ...
  if(isset($_POST['submit']))
  {
    ...
    {   
        ...
        $fields = array(
                        ...
                        'data' => array("foo" => "bar","new_id"=>$_POST['new_id'],"external_link"=>$external_link),
        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Enviar Notificación</div>
            </div>
          </div>
            ...
            <form action="" name="addeditcategory" method="post" class="form form-horizontal" enctype="multipart/form-data">
              ...
              <div class="section">
                <div class="section-body">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Imagen :-<br/>(Opcional)<p class="control-label-help">(Resolucion recomendada: 600x293 or 650x317 or 700x342 or 750x366)</p></label>
                  ...
                  <div class="form-group">
                    <label class="col-md-4 control-label">Noticia :-<br/>(Opcional)
                    <p class="control-label-help">Para abrir noticias únicas directamente cuando haga clic en notificación</p></label>
                    <div class="col-md-8">
                      <select name="new_id" id="new_id" class="select2" required>
                        <option value="0">--Seleccione Noticia--</option>
                        <?php
                            while($data_row=mysqli_fetch_array($data_result))
                            {
                        ?>                       
                        <option value="<?php echo $data_row['id'];?>"><?php echo $data_row['news_title'];?></option>                           
                        <?php
                          }
                        ?>
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input type="text" name="external_link" id="external_link" class="form-control" value="" placeholder="http://www.adc.com">
                    </div>
                  </div>   
                </div>   
                  <div class="form-group">
